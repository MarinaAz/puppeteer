...
class SearchResultsPage extends BasePageObject { 
    constructor(browser, page) {
        ...
        this.atPageSelector = `.RgSearchResultView`         
        this.searchNavigationTabsSelector = `.submenuPanel li`

        //---------- actions menu
        this.actionsMenuButtonSelector = `.ActionsBar button`
    ...
    async assertAtPage() {
        ...
        //extra wait here too to account for the semi-reloading that can happe
    ...
    //clicks 'Search' or 'Results' in the tabs on this page
    async clickSearchNavigationTab(tabName) {
        let tabElement = await common.findElementInListHavingText(await this.page.$$(this.searchNavigationTabsSelector), tabName)
