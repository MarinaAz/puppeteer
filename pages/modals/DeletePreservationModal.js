...
class DeletePreservationModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Delete Preservation")
    }
...
module.exports = DeletePreservationModal