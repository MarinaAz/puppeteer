...
class CollectDocumentsModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Collect documents")
    }
...
module.exports = CollectDocumentsModal