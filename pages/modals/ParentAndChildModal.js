...
class ParentAndChildModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Parent and child")
    }
...
module.exports = ParentAndChildModal