...
class RemoveAllDocumentsModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Remove All Documents")   
    }
...
module.exports = RemoveAllDocumentsModal