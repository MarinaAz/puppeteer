...
class PreserveDocumentsModal extends BasePageObject { 
    constructor(browser, page) {
        super(browser, page)  
        
        this.headerSelector = `h6`
        this.scopeSelector = `.rg-dialog`
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Preserve documents")
    }
...
module.exports = PreserveDocumentsModal