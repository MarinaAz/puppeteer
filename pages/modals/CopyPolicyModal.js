...
class CopyPolicyModal extends BasePageObject { 
    constructor(browser, page) {
        super(browser, page)

        this.headerSelector = `h6`
        this.nameSelector = `.bp4-form-group input[placeholder="Required"]`
        this.descSelector = `.bp4-dialog-body div:nth-child(4) input`
        this.selectFolderInputSelector  = `.bp4-form-group:nth-child(2) input[type="text"]`
        this.buttonsSelector = `.bp4-dialog-footer-actions button`
    }   

    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Copy Policy")
...
module.exports = CopyPolicyModal