...
class AddToADeletionModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Add to a deletion")
    }
...
module.exports = AddToADeletionModal