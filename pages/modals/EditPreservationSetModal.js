...
class EditPreservationSetModal extends BasePageObject { 
    ...
    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Edit Preservation Set")
...
module.exports = EditPreservationSetModal