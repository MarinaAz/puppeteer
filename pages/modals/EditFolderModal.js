...
class EditFolderModal extends BasePageObject { 
    constructor(browser, page) {
        ...
        this.buttonsSelector = `.bp4-dialog-footer-actions .bp4-button-text`
    }   

    async assertAtPage() { 
        await common.waitForText(this.page, this.headerSelector, "Edit Folder")
